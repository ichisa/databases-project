...
date<-as.Date(paste(EVI2010_1$X1,EVI2010_1$X2, EVI2010_1$X3,sep="-"),"%Y-%m-%d") #Converts the first three columns in one column with the date 
EVI2010_1$date<-date
...
df2010_2<- subset(df2010_2, select=-poligon)#removes the info of the poligon as a character
